...
const INITIAL_MODULES: WeekModule[] = [
  {
    ...
    items: [
      { id: "w1-d1", title: "Day 1: Intro to Data Analytics & Python", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(1) },
      ...
      { id: "w1-d3", title: "Day 3: Loops and Functions", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(3) },
      { id: "w1-d4", title: "Day 4: String and List", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(4) },
      { id: "w1-d5", title: "Day 5: Dictionary, Tuple and Set", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(5) },
      { id: "w1-d6", title: "Day 6: Python Collections", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(6) },
      { id: "w1-d7", title: "Day 7: Advanced Python Concepts", type: "Project", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(7) },
    ]
  },
  {
    id: 2,
    ...
    items: [
      { id: "w2-d8", title: "Day 8: Introduction to Statistics", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(8) },
      { id: "w2-d9", title: "Day 9: Probability & Distributions", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(9) },
      { id: "w2-d10", title: "Day 10: Understanding Data Relationships", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(10) },
      { id: "w2-d11", title: "Day 11: CLT & Hypothesis Testing", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(11) },
      { id: "w2-d12", title: "Day 12: Parametric Testing Techniques", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(12) },
      { id: "w2-d13", title: "Day 13: Non-Parametric Testing", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(13) },
      { id: "w2-d14", title: "Day 14: Data Skewness Detection", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(14) },
    ]
  },
  {
    id: 3,
    ...
    items: [
      { id: "w3-d15", title: "Day 15: Introduction to NumPy", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(15) },
      { id: "w3-d16", title: "Day 16: Introduction to Pandas", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(16) },
      { id: "w3-d17", title: "Day 17: Data Inspection in Pandas", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(17) },
      { id: "w3-d18", title: "Day 18: Pandas Advanced Operations", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(18) },
      { id: "w3-d19", title: "Day 19: Missing Data Handling", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(19) },
      { id: "w3-d20", title: "Day 20: Outlier Detection", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(20) },
      { id: "w3-d21", title: "Day 21: Duplicate Data Handling", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(21) },
    ]
  },
  {
    id: 4,
    ...
    items: [
      { id: "w4-d22", title: "Day 22: Matplotlib Visualization", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(22) },
      { id: "w4-d23", title: "Day 23: Seaborn Visualization", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(23) },
      { id: "w4-d24", title: "Day 24: Interactive Viz with Plotly", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(24) },
      { id: "w4-d25", title: "Day 25: Correlation Matrix & Heatmaps", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(25) },
      { id: "w4-d26", title: "Day 26: Time Series Visualization", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(26) },
      { id: "w4-d27", title: "Day 27: Project - Word Clouds", type: "Project", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(27) },
      { id: "w4-d28", title: "Day 28: Project - Zomato Analysis", type: "Project", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(28) },
    ]
  },
  {
    id: 5,
    ...
    items: [
      { id: "w5-d29", title: "Day 29: Intro to Web Scraping", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(29) },
      { id: "w5-d30", title: "Day 30: Web Scraping Tools", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(30) },
      { id: "w5-d31", title: "Day 31: Dynamic Web Scraping", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(31) },
      { id: "w5-d32", title: "Day 32: Post-Scraping Data Cleaning", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(32) },
      { id: "w5-d33", title: "Day 33: Exploratory Data Analysis", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(33) },
      { id: "w5-d34", title: "Day 34: Advanced EDA Project", type: "Project", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(34) },
  ...
  },
  {
    ...
    items: [
      { id: "w6-d36", title: "Day 36: Excel Basics", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(36) },
      { id: "w6-d37", title: "Day 37: Excel Data Management", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(37) },
      { id: "w6-d38", title: "Day 38: Lookup & Text Functions", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(38) },
      { id: "w6-d39", title: "Day 39: Logical & Date Functions", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(39) },
      { id: "w6-d40", title: "Day 40: Excel Pivot Tables", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(40) },
      { id: "w6-d41", title: "Day 41: Charting & Dashboards", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(41) },
  ...
  },
  {
    ...
    items: [
      { id: "w7-d43", title: "Day 43: Intro to SQL", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(43) },
      { id: "w7-d44", title: "Day 44: SQL Basics", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(44) },
      { id: "w7-d45", title: "Day 45: SQL Aggregations", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(45) },
      { id: "w7-d46", title: "Day 46: SQL Joins", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(46) },
      { id: "w7-d47", title: "Day 47: Operators & Subqueries", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(47) },
      { id: "w7-d48", title: "Day 48: Window Functions & Optimization", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(48) },
  ...
  },
  {
    ...
    items: [
      { id: "w8-d50", title: "Day 50: Power BI Intro", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(50) },
      { id: "w8-d51", title: "Day 51: Data Preparation", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(51) },
      { id: "w8-d52", title: "Day 52: DAX Basics", type: "Topic", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(52) },
      { id: "w8-d53", title: "Day 53: Advanced DAX", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(53) },
      { id: "w8-d54", title: "Day 54: Visualizations", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(54) },
      { id: "w8-d55", title: "Day 55: Dashboards & Reports", type: "Project", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(55) },
  ...
  },
  {
    ...
    items: [
      { id: "w9-d57", title: "Day 57: Intro to Tableau", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(57) },
      { id: "w9-d58", title: "Day 58: Charting Basics", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(58) },
      { id: "w9-d59", title: "Day 59: Data Structure", type: "Topic", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(59) },
      { id: "w9-d60", title: "Day 60: Calculated Fields", type: "Task", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(60) },
      { id: "w9-d61", title: "Day 61: Filters & Actions", type: "Task", status: Status.NOT_STARTED, ownerId: "collins", dueDate: getRelativeDate(61) },
      { id: "w9-d62", title: "Day 62: Tableau Dashboards", type: "Project", status: Status.NOT_STARTED, ownerId: "sophia", dueDate: getRelativeDate(62) },
