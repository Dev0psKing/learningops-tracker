...
import { LayoutDashboard, BookOpen, Activity, Target, Bell, Notebook, Briefcase, FileText, HelpCircle, Settings, Sun, Moon, Download, Upload, Layers, Database, CheckCircle, AlertTriangle, Sparkles, Menu, X } from './components/Icons';
          ...
          <header className="h-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 lg:px-8 flex-shrink-0">
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <button
                  ...
                  className="p-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                <Menu className="w-6 h-6" />
              </button>

              <div className="flex flex-col">
                <h2 className="text-lg lg:text-2xl font-bold text-slate-900 dark:text-white leading-tight">
            ...
            <div className="flex items-center gap-3 lg:gap-6">
              ...
              <div className="flex items-center gap-1 lg:gap-2 bg-slate-100 dark:bg-slate-800 p-1 rounded-full border border-slate-200 dark:border-slate-700">
                {users.map(u => (
                    <button
                        key={u.id}
