...
import { Briefcase, Trash, FileText, HelpCircle, Target, Activity, CheckCircle, BrainCircuit, Lock, AlertTriangle } from './Icons';
                  ...
                  {(interviewStatus === 'answering' || interviewStatus === 'evaluating') && (
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          ...
                          {/* Current Question */}
                          <div className="bg-white dark:bg-slate-800 p-4 rounded-xl rounded-tl-none border border-indigo-200 dark:border-indigo-500 shadow-md max-w-[90%] animate-fade-in">
